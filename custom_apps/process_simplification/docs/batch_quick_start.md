...
[查看验收记录与手机模拟截图](local_delivery_acceptance_20260915.md)。 **状态更正：批次业务示例已验证，但本机初始化收尾和桌面导航问题尚未关闭，整站验收未通过。**飞书对应章节已同步五步操作和新截图；本轮使用 390×844 浏览器手机模拟，正式站尚未部署。
...
飞书对应章节：[09｜批次自动管理与追溯](https://rcnz1aofm14f.feishu.cn/wiki/JAzTwkSITixJK2kGv1JcIZPundh)。本卡说明最新兼容功能与配置方法，不代表已替企业开启设置或部署正式站。
