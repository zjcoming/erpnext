							...
							.map((row) => {
								...
								return `<article class="worker-assignment-card">
									...
									<div class="worker-assignment-facts">
										...
										${row.active_started_at ? `<span>${__("开始时间")}：${esc(frappe.datetime.str_to_user(normalizeFrappeDateTime(row.active_started_at)))}</span>` : ""}
